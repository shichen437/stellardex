...
func (c *sysGroupItemController) Search(ctx context.Context, req *v1.SearchGroupItemReq) (res *v1.SearchGroupItemRes, err error) {
	return service.UserGroupItem().Search(ctx, req)
}
